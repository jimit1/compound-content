...
<Schema type="BreadcrumbList" data={{
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Home", item: "https://abmatic.ai/" },
    { "@type": "ListItem", position: 2, name: "Glossary", item: "https://abmatic.ai/glossary/" },
    { "@type": "ListItem", position: 3, name: "Agentic Marketing", item: "https://abmatic.ai/glossary/agentic-marketing/" }
  ]
}} />
...
<CTAInline
  primary={{ label: "See how Abmatic's agents run B2B demand gen — 30 min demo", href: "/demo" }}
  secondary={{ label: "Meet Compound — our own agentic marketing agency", href: "/compound-story/" }}
/>
...
- [Clara — Abmatic's pipeline AI](/products/clara-ai/)
- [Agentic Chat — orchestration module](/products/agentic-chat/)
