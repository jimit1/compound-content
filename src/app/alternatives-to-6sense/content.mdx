...
<CTAInline
  primary={{ label: "See Abmatic in 30 minutes — no RevOps team required", href: "/demo" }}
  secondary={{ label: "Download the 6sense migration playbook", href: "/resources/6sense-migration-playbook/" }}
/>
...
- [Abmatic vs 6sense — feature-by-feature](/compare/abmatic-vs-6sense/)
